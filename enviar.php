...
echo "<script>alert('Los campos marcados con * son obligatorios');location.href ='javascript:history.back()';</script>";
    ...
    $mail->AddAddress("probandowebhtml2001@gmail.com"); // Dirección a la que llegaran los mensajes.
...
// Datos del servidor SMTP, podemos usar el de Google, Outlook, etc...
    ...
    $mail->SMTPAuth = true; 
    $mail->Username = "probandowebhtml2001@gmail.com";  // Correo Electrónico
    $mail->Password = "4599709mcC"; // Contraseña del correo
